#ifndef _RASTERIZER_PS2_H_
#define _RASTERIZER_PS2_H_
...
class RasterizerPS2 : public Rasterizer
{
public:
	RasterizerPS2();
	virtual ~RasterizerPS2();
...
private:
	struct Texture
	{
		...
		Texture() : flags(0), width(0), height(0), format(Image::FORMAT_GRAYSCALE) { }
		~Texture() { }
	};
